...
Original file is located at
    https://colab.research.google.com/drive/1ml5c8i9211xdKvNL7QmoBvL8HZzZmEVa
"""
...
training_data = read_data('/content/drive/MyDrive/IMAGES-T3')
		
    # Shuffle for more randomness
random.shuffle(training_data)

# Create a GA of neural nets
img_len = len(training_data)
ga = GeneticAlgorithm(epochs=2,
                                mutation_rate = 0.01,
                                data = training_data,
